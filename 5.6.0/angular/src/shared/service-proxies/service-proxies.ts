...
@Injectable()
export class HelpDesksServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    getHelpDeskForEdit(id: number | undefined): Observable<GetHelpDeskForEditOutput> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetHelpDeskForEdit(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetHelpDeskForEdit(<any>response_);
                } catch (e) {
                    return <Observable<GetHelpDeskForEditOutput>><any>_observableThrow(e);
                }
            } else
                return <Observable<GetHelpDeskForEditOutput>><any>_observableThrow(response_);
        }));
    }

    protected processGetHelpDeskForEdit(response: HttpResponseBase): Observable<GetHelpDeskForEditOutput> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = GetHelpDeskForEditOutput.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<HelpDeskDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<HelpDeskDto>><any>_observableThrow(response_);
        }));
    }

    protected processGet(response: HttpResponseBase): Observable<HelpDeskDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = HelpDeskDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<HelpDeskDto>(<any>null);
    }
     ...
     * @return Success
     */
    getAll(sorting: string | null | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<HelpDeskDtoPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/HelpDesks/GetAll?";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<HelpDeskDtoPagedResultDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<HelpDeskDtoPagedResultDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<HelpDeskDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = HelpDeskDtoPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<HelpDeskDtoPagedResultDto>(<any>null);
    }
    ...
    protected processCreate(response: HttpResponseBase): Observable<HelpDeskDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    update(body: HelpDeskDto | undefined): Observable<HelpDeskDto> {
        let url_ = this.baseUrl + "/api/services/app/HelpDesks/Update";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processUpdate(response: HttpResponseBase): Observable<HelpDeskDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    delete(id: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/HelpDesks/Delete?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
...
export class RoleServiceProxy {
     ...
     * @return Success
     */
    doIt(): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Role/DoIt";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processDoIt(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processDoIt(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    protected processDoIt(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class HelpDeskDto implements IHelpDeskDto {
    ...
    static fromJS(data: any): HelpDeskDto {
        data = typeof data === 'object' ? data : {};
        let result = new HelpDeskDto();
        result.init(data);
        return result;
    }
...
export class HelpDeskDtoPagedResultDto implements IHelpDeskDtoPagedResultDto {
    totalCount: number;
    items: HelpDeskDto[] | undefined;

    constructor(data?: IHelpDeskDtoPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["items"])) {
                ...
                for (let item of _data["items"])
                    this.items.push(HelpDeskDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): HelpDeskDtoPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new HelpDeskDtoPagedResultDto();
        result.init(data);
        return result;
    }
    ...
    clone(): HelpDeskDtoPagedResultDto {
        const json = this.toJSON();
        let result = new HelpDeskDtoPagedResultDto();
        result.init(json);
        return result;
...
export interface IHelpDeskDtoPagedResultDto {
    totalCount: number;
    items: HelpDeskDto[] | undefined;
}
